...
public class Scenario_ID6101 extends BaseClass {

	public Scenario_ID6101(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB,String T2DOB) throws InterruptedException, IOException {
		...
		logger.info("Scenario:Verify user able to create T&M policy with Couple, ST - U/W declined");
