...
public class Scenario_ID6113 extends BaseClass {

	public Scenario_ID6113(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB) throws InterruptedException, IOException {
		...
		logger.info("ID6113 - Validation: ST - Traveler DOB for Individual - The maximum age for this trip is 100");
		...
		logger.info("Expected Error message is - The maximum age for this trip is 100");
		logger.info("Actual Error message is:-"+ TC_obj.Invalid_TDOB_Error_message.getText());
	}
