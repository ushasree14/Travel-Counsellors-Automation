...
public class Scenario_ID3991 extends BaseClass {

	public Scenario_ID3991(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB,String T2DOB) throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		 TC_obj.T1DOB.sendKeys(T1DOB);
		  ...
		  Thread.sleep(3000);
		logger.info("Scenario: Verify user able to create T&M policy with Couple, AMT");
