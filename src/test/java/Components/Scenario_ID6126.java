...
public class Scenario_ID6126 extends BaseClass {
	
	
	public Scenario_ID6126(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String StartDate, String EndDate, String T1DOB) throws InterruptedException, IOException {
		...
		logger.info(
				"Scenario: Check what happens if we enter invalid CVV card details in payment page");
	...
	public void Payment_Details(String cardnumber, String securityCVV) throws InterruptedException {
		...
		logger.info("Invalid CVV number is:- "+securityCVV);
...
//		Please enter your security number
		Assert.assertEquals("Please enter your security number", TC_obj.Invalid_CVV_number_error_message.getText());
		
		logger.info("Actual Error Message is:- "+TC_obj.Invalid_CVV_number_error_message.getText());
