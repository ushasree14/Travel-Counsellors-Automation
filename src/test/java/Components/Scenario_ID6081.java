...
public class Scenario_ID6081 extends BaseClass {
	
	
	public Scenario_ID6081(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB) throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		logger.info(
				"Scenario: What happens if we don't select - Traveller date of birth");
		 ...
		 */
		takeScreenshot("Scenario_ID6081_ContinueButton");
		Thread.sleep(5000);
