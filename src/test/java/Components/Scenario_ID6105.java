...
public class Scenario_ID6105 extends BaseClass {

	public Scenario_ID6105(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB,String T2DOB, String T3DOB, String T4D0B, String T5D0B) throws InterruptedException, IOException {
		...
		logger.info("Scenario: Verify user able to create T&M policy with SPF, ST - U/W declined");
