...
public class Scenario_ID3971 extends BaseClass {
	
	public Scenario_ID3971(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB, String T2DOB, String T3DOB, String T4DOB, String T5DOB, String T6DOB, String T7DOB, String T8DOB, String T9DOB, String T10DOB) throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		logger.info(
				"Verify user able to create Travel policy with Group, ST: Accept Cookies, Europe, Group(10), Travel Only, Premier, Wedding Cover");
	...
	public void Travel_details_fields_1(String FN_Traveler1, String LN_Traveler1,String FN_Traveler2,
			...
			String FN_Traveler10, String LN_Traveler10, String Address_Line1, String city,
		...
		TC_obj.Traveller_Title9_Dropdown.click();
		TC_obj.Title9_option.click();
		TC_obj.FN_Traveler9.sendKeys(FN_Traveler9);
		TC_obj.LN_Traveler9.sendKeys(LN_Traveler9);
		
		TC_obj.Traveller_Title10_Dropdown.click();
		TC_obj.Title10_option.click();
		TC_obj.FN_Traveler10.sendKeys(FN_Traveler10);
		TC_obj.LN_Traveler10.sendKeys(LN_Traveler10);
		Thread.sleep(3000);
		...
		logger.info("completed Traveler Details Page");
	...
	public void Payment_Details(String cardnumber, String securityCVV) {
		...
		TC_WebElements TC_obj = new TC_WebElements(driver);
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		logger.info("started payment Page");
		...
		logger.info("completed payment Page");
