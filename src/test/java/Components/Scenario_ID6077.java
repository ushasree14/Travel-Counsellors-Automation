...
public class Scenario_ID6077 extends BaseClass {
	
	
	public Scenario_ID6077(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB) throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		logger.info(
				"Scenario: What happens if we don't select - Where are you travelling to? ");
		TC_obj.Continue.click();
		takeScreenshot("Scenario_ID6077_ContinueButton");
		Thread.sleep(5000);

		WebElement error = driver.findElement(By.xpath("/html/body/div[1]/div/div[3]/main/div/form/div[1]/div/div"));
		
		logger.info(TC_obj.Europe.getAttribute("span"));
