...
public class Scenario_ID3987 extends BaseClass {

	
	public Scenario_ID3987(WebDriver driver) {
		this.driver = driver;
...
TC_WebElements TC_obj = new TC_WebElements(driver);
		...
		Thread.sleep(5000);
		wait.until(ExpectedConditions.visibilityOf(TC_obj.GolfCover));
		TC_obj.GolfCover.click();

		logger.info("Scenario: Verify user able to create Travel policy with SPF, AMT");
