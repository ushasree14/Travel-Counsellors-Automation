...
public class Scenario_ID3993 extends BaseClass {

	public Scenario_ID3993(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB, String T4D0B, String T5D0B) throws InterruptedException, IOException {
		...
		logger.info("Scenario: Verify user able to create T&M policy with SPF, AMT");
	...
	@Test(priority = 4)
	public void Medical_Conditions(String med_conditionT1,String med_conditionT2,String med_conditionT3) throws InterruptedException {
		TC_WebElements TC_obj = new TC_WebElements(driver);
		JavascriptExecutor js = (JavascriptExecutor) driver;
