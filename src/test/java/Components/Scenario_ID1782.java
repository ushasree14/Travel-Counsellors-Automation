...
public class Scenario_ID1782 extends BaseClass {
	
	public Scenario_ID1782(WebDriver driver) {
		this.driver=driver;
	}
	@Test
...
driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	...
	public void PreExistingMedicalQuesTest() throws InterruptedException {
		...
		logger.info("illness_question");
		TC_obj.symptoms_question.click();
		logger.info("symptoms_question");
	...
	public void Travel_details_fields_1(String FN_Traveler1, String LN_Traveler1,String FN_Traveler2,
		...
		logger.info("Entered all Traveller details fields");
	}
