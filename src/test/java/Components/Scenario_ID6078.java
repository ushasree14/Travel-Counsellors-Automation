...
public class Scenario_ID6078 extends BaseClass {
	
	
	public Scenario_ID6078(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB) throws InterruptedException, IOException {
		...
		Thread.sleep(2000);
		logger.info(
				"Scenario: What happens if we don't select - Trip start date");
