...
public class Scenario_ID6125 extends BaseClass {
	
	
	public Scenario_ID6125(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String StartDate, String EndDate, String T1DOB) throws InterruptedException, IOException {
		...
		logger.info(
				"Scenario: Check what happens if we enter invalid card details in payment page");
	...
	public void Payment_Details(String cardnumber, String securityCVV) throws InterruptedException {
		...
		logger.info("Invalid Payment card number is:- "+cardnumber);
...
//		Please enter your card number
		Assert.assertEquals("Please enter your card number", TC_obj.Invalid_card_number_error_message.getText());
		
		logger.info("Actual Error message is:- "+TC_obj.Invalid_card_number_error_message.getText());
