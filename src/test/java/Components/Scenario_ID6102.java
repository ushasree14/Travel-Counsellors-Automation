...
public class Scenario_ID6102 extends BaseClass {

	public Scenario_ID6102(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB,String T2DOB) throws InterruptedException, IOException {
		...
		logger.info("Scenario:Verify user able to create T&M policy with Couple, AMT - U/W declined");
