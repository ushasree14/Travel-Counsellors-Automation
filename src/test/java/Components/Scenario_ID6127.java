...
public class Scenario_ID6127 extends BaseClass {

	public Scenario_ID6127(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String StartDate, String EndDate, String T1DOB) throws InterruptedException, IOException {
		...
		logger.info("Scenario: Check what happens if we click cancel in Payment page");
	...
	public void Payment_Details(String cardnumber, String securityCVV) throws InterruptedException {
		 ...
		 * TC_obj.Payment_page_Cancel_button.click(); Thread.sleep(5000);
		 */
		logger.info("Clicked on cancel and redirected to traveler Page");
