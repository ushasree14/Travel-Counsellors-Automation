...
public class Scenario_ID1813 extends BaseClass {
	
	public Scenario_ID1813(WebDriver driver) {
		this.driver = driver;
	...
	public void Verify_HTTPS() {
		...
		if(current_url.contains("https")) {
			System.out.println("HTTPS header Verified successfully in this current screen URL:- "+ current_url);
		}else {
			System.out.println("HTTPS header not placed in this current URL");
		}
		
	}
	
	public void GetQuoteTest(String T1DOB, String T2DOB, String T3DOB, String T4DOB, String T5DOB, String T6DOB) throws InterruptedException, IOException {
		...
		wait.until(ExpectedConditions.visibilityOf(TC_obj.AnnualTrip));
		TC_obj.AnnualTrip.click();
		logger.info("Clicked AnnualTrip");
		wait.until(ExpectedConditions.visibilityOf(TC_obj.WWInc));
		TC_obj.WWInc.click();
		wait.until(ExpectedConditions.visibilityOf(TC_obj.Today));
		TC_obj.Today.click();
		TC_obj.Group.click();
		wait.until(ExpectedConditions.visibilityOf(TC_obj.Groupsix));
		TC_obj.Groupsix.click();
		...
		logger.info(
				"Scenario: A user can see clear HTTPS headers on all ROCK pages through the quote journey");
	...
	public void Travel_details_fields_1(String FN_Traveler1, String LN_Traveler1,String FN_Traveler2,
			...
			String FN_Traveler5, String LN_Traveler5, String FN_Traveler6, String LN_Traveler6,  String Address_Line1, String city,
		...
		wait.until(ExpectedConditions.visibilityOf(TC_obj.Traveller_Title6_Dropdown));
