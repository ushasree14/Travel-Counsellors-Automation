...
public class Scenario_ID3943 extends BaseClass {
	
	public Scenario_ID3943(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void GetQuoteTest(String T1DOB, String T2DOB, String T3DOB, String T4D0B) throws InterruptedException, IOException {
TC_WebElements TC_obj = new TC_WebElements(driver);
		...
		logger.info("Scenario: Verify user able to create Travel policy with Family,AMT");
	...
	public void QuotePageTest() throws InterruptedException {
		...
		TC_WebElements TC_obj = new TC_WebElements(driver);
		TC_obj.UltimateFamily.click();
		logger.info("Clicked on Premier Product");
		Thread.sleep(3000);
		TC_obj.Travel_Disruption_Cover.click();
		logger.info("Clicked on Travel_Disruption_Cover");
		Thread.sleep(3000);
