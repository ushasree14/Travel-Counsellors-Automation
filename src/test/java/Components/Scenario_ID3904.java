...
public class Scenario_ID3904 extends BaseClass {
	
	public Scenario_ID3904(WebDriver driver) {
		this.driver = driver;	}
...
TC_WebElements TC_obj = new TC_WebElements(driver);
		...
		logger.info("Scenario: Verify user able to create Travel policy with Family, ST");
	...
	public void QuotePageTest() throws InterruptedException {
		...
		logger.info("Clicked on wedding Cover");
		Thread.sleep(3000);
