...
import Components.Scenario_ID1817;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1817 extends BaseClass {

	String expected_ID = "ID1817";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1817(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1817 SC_ID1817 = new Scenario_ID1817(driver);
		//driver.get(URL);
	//	logger.info("Launching the website");

		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1817.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB, T5DOB, T6DOB, T7DOB, T8DOB, T9DOB, T10DOB);
			takeScreenshot("Scenario_ID1817_GetQuoteTest");
