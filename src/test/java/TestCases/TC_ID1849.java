...
import Components.Scenario_ID1849;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1849 extends BaseClass {
	
	String expected_ID = "ID1849";
	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1849(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1849 SC_ID1849 = new Scenario_ID1849(driver);
		//driver.get(URL);
	//	logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1849.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID1849.Verify_PolicyDocumentation_Page_Links();
			takeScreenshot("Scenario_ID1849_Verify_PolicyDocumentation_Page_Links");
		}
	}
