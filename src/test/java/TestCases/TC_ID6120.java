...
public class TC_ID6120 extends BaseClass {
	
	String expected_ID = "ID6120";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6120(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6120 SC_ID6120 = new Scenario_ID6120(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			logger.info(TestCaseID);
			SC_ID6120.GetQuoteTest(T1DOB);
			SC_ID6120.PreExistingMedicalQuesTest();
			
			takeScreenshot("Scenario_ID6120_PreExistingMedicalQuesTest");
			logger.info("6120 Test Passed");
		}
	}
