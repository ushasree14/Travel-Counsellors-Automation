...
public class TC_ID1803 extends BaseClass {
	
	String expected_ID = "ID1803";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1803(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1803 SC_ID1803 = new Scenario_ID1803(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1803.GetQuoteTest(T1DOB, T2DOB, T3DOB);
			SC_ID1803.PreExistingMedicalQuesTest();
			SC_ID1803.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, Address_Line1, city, County, PostCode);
			takeScreenshot("Scenario_ID1803_Travel_details_fields_1");
