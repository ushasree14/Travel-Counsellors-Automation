...
import Components.Scenario_ID1798;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1798 extends BaseClass {
	
	String expected_ID = "ID1798";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1798(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1798 SC_ID1798 = new Scenario_ID1798(driver);
	
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1798.GetQuoteTest(T1DOB);
			takeScreenshot("Scenario_ID1798_GetQuoteTest");
		}
