...
import Components.Scenario_ID6116;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6116 extends BaseClass {
	
	String expected_ID = "ID6116";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6116(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6116 SC_ID6116 = new Scenario_ID6116(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6116.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB);
			
			takeScreenshot("Scenario_ID6116_Payment_Details");
			logger.info(" 6116 Test Passed");
