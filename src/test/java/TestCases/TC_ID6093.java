...
import Components.Scenario_ID6093;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6093 extends BaseClass {
	
	String expected_ID = "ID6093";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6093(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6093 SC_ID6093 = new Scenario_ID6093(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6093.GetQuoteTest(EndDate, T1DOB );
