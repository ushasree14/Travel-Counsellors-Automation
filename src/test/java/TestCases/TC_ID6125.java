...
import Components.Scenario_ID3982;
import Components.Scenario_ID6125;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6125 extends BaseClass {
	
	String expected_ID = "ID6125";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6125(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6125 SC_ID6125 = new Scenario_ID6125(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6125.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID6125.PreExistingMedicalQuesTest();
			SC_ID6125.QuotePageTest();
			SC_ID6125.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID6125.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID6125_Payment_Details");
			logger.info(" 6125 Test Passed");
		}
	}
