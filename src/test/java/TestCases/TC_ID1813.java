...
import Components.Scenario_ID1813;
import Components.Scenario_ID3972;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1813 extends BaseClass {
	
	String expected_ID = "ID1813";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1813(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1813 SC_ID1813 = new Scenario_ID1813(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1813.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB, T5DOB, T6DOB);
			SC_ID1813.PreExistingMedicalQuesTest();
			SC_ID1813.QuotePageTest();
			SC_ID1813.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, FN_Traveler4, LN_Traveler4, FN_Traveler5, LN_Traveler5, FN_Traveler6, LN_Traveler6,
					Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID1813.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID1813_Payment_Details");
