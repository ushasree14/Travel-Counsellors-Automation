...
import Components.Scenario_ID1836;
import Components.Scenario_ID3945;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1836 extends BaseClass {
	
	String expected_ID = "ID1836";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1836(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1836 SC_ID1836 = new Scenario_ID1836(driver);
		//driver.get(URL);
	//	logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);

			SC_ID1836.GetQuoteTest(T1DOB);
			SC_ID1836.PreExistingMedicalQuesTest();
			SC_ID1836.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode);
			SC_ID1836.Medical_Conditions(med_conditionT1);
			SC_ID1836.QuotePageTest();
			SC_ID1836.Travel_details_fields_2(Phonenumber, Email);
			SC_ID1836.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID1836_Payment_Details");
		}
	}
