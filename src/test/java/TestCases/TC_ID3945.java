...
import Components.Scenario_ID3941;
import Components.Scenario_ID3945;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID3945 extends BaseClass {

	String expected_ID = "ID3945";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3945(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3945 SC_ID3945 = new Scenario_ID3945(driver);
		//driver.get(URL);
	//	logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);

			SC_ID3945.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB);
			takeScreenshot("Scenario_ID3945_GetQuoteTest");
			SC_ID3945.PreExistingMedicalQuesTest();
			takeScreenshot("Scenario_ID3945_PreExistingMedicalQuesTest");
			SC_ID3945.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, FN_Traveler4, LN_Traveler4, Address_Line1, city, County, PostCode);
			takeScreenshot("Scenario_ID3945_Travel_details_fields_1");
			SC_ID3945.Medical_Conditions(med_conditionT1, med_conditionT2, med_conditionT3, med_conditionT4);
			takeScreenshot("Scenario_ID3945_Medical_Conditions");
			SC_ID3945.QuotePageTest();
			takeScreenshot("Scenario_ID3945_QuotePageTest");
			SC_ID3945.Travel_details_fields_2(Phonenumber, Email);
			takeScreenshot("Scenario_ID3945_Travel_details_fields_2");
			SC_ID3945.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID3945_Payment_Details");
		}
	}
