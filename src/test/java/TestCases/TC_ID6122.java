...
import Components.Scenario_ID6122;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6122 extends BaseClass {
	
	String expected_ID = "ID6122";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6122(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6122 SC_ID6122 = new Scenario_ID6122(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6122.GetQuoteTest(T1DOB);
			SC_ID6122.PreExistingMedicalQuesTest();
			SC_ID6122.QuotePageTest();
			
			takeScreenshot("Scenario_ID6122_Payment_Details");
			logger.info(" 6122 Test Passed");
		}
	}
