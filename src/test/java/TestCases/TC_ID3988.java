...
public class TC_ID3988 extends BaseClass {
	
	String expected_ID = "ID3988";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3988(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3988 SC_ID3988 = new Scenario_ID3988(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3988.GetQuoteTest(T1DOB);
			SC_ID3988.PreExistingMedicalQuesTest();
			SC_ID3988.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode);
			SC_ID3988.Medical_Conditions(med_conditionT1);
			SC_ID3988.QuotePageTest();
			SC_ID3988.Travel_details_fields_2(Phonenumber, Email);
			SC_ID3988.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID3988_Payment_Details");
