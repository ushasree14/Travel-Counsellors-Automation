...
public class TC_ID3982 extends BaseClass {
	
	String expected_ID = "ID3982";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3982(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3982 SC_ID3982 = new Scenario_ID3982(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3982.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID3982.PreExistingMedicalQuesTest();
			SC_ID3982.QuotePageTest();
			SC_ID3982.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID3982.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID3982_Payment_Details");
