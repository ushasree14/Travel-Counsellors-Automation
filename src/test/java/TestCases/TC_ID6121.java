...
import Components.Scenario_ID6119;
import Components.Scenario_ID6120;
import Components.Scenario_ID6121;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6121 extends BaseClass {
	
	String expected_ID = "ID6121";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6121(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6121 SC_ID6121 = new Scenario_ID6121(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			logger.info(TestCaseID);
			SC_ID6121.GetQuoteTest(T1DOB);
			SC_ID6121.PreExistingMedicalQuesTest();
			
			takeScreenshot("Scenario_ID6121_Payment_Details");
			logger.info("6121 Test Passed");
		}
	}
