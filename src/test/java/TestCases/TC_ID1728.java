...
public class TC_ID1728 extends BaseClass {
	...
	String expected_ID = "ID1728";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1728(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			...
			SC_ID1728.GetQuoteTest(T1DOB);
			SC_ID1728.PreExistingMedicalQuesTest();
			SC_ID1728.QuotePageTest();
			takeScreenshot("Scenario_ID1728_QuotePageTest");
		}
