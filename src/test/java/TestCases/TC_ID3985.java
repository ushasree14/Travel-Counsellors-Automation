...
import Components.Scenario_ID3985;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID3985 extends BaseClass {
	
	String expected_ID = "ID3985";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3985(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3985 SC_ID3985 = new Scenario_ID3985(driver);
		//driver.get(URL);
	//	logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3985.GetQuoteTest(T1DOB, T2DOB);
			SC_ID3985.PreExistingMedicalQuesTest();
			SC_ID3985.QuotePageTest();
			SC_ID3985.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID3985.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID3985_Payment_Details");
