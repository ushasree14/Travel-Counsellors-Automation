...
import Components.Scenario_ID1820;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1820 extends BaseClass {
	
	String expected_ID = "ID1820";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1820(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1820 SC_ID1820 = new Scenario_ID1820(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1820.GetQuoteTest(T1DOB, StartDate, EndDate);
			takeScreenshot("Scenario_ID1820_GetQuoteTest");
		}
	}
