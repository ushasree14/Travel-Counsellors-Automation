...
import Components.Scenario_ID6159;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6159 extends BaseClass {
	
	String expected_ID = "ID6159";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6159(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6159 SC_ID6159 = new Scenario_ID6159(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6159.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID6159.PreExistingMedicalQuesTest();
			SC_ID6159.QuotePageTest();
			
			takeScreenshot("Scenario_ID6159_Payment_Details");
			logger.info(" 6159 Test Passed");
		}
	}
