...
import Components.Scenario_ID1806;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1806 extends BaseClass {
	
	String expected_ID = "ID1806";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1806(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1806 SC_ID1806 = new Scenario_ID1806(driver);
	
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1806.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID1806.PreExistingMedicalQuesTest();
			SC_ID1806.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode);
			SC_ID1806.Medical_Conditions(med_conditionT1);
			takeScreenshot("Scenario_ID1806_Medical_Conditions");
