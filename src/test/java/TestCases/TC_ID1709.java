...
public class TC_ID1709 extends BaseClass {
	...
	String expected_ID = "ID1709";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1709(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			...
			takeScreenshot("Scenario_ID1709_DocumentsTest");
		}
