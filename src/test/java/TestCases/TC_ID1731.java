...
import Components.Scenario_ID1731;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1731 extends BaseClass {
	
	
	
	String expected_ID = "ID1731";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1731(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1731 SC_ID1731 = new Scenario_ID1731(driver);
	
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1731.GetQuoteTest(T1DOB);
			SC_ID1731.PreExistingMedicalQuesTest();
			takeScreenshot("Scenario_ID1731_PreExistingMedicalQuesTest");
		}
