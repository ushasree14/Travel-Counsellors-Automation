...
import Components.Scenario_ID3984;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID3984 extends BaseClass {
	
	String expected_ID = "ID3984";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3984(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3984 SC_ID3984 = new Scenario_ID3984(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3984.GetQuoteTest(T1DOB, T2DOB);
			SC_ID3984.PreExistingMedicalQuesTest();
			SC_ID3984.QuotePageTest();
			SC_ID3984.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID3984.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID3984_Payment_Details");
