...
import Components.Scenario_ID1729;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1729 extends BaseClass {
	
	
	String expected_ID = "ID1729";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1729(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1729 SC_ID1729 = new Scenario_ID1729(driver);
		...
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			...
			SC_ID1729.GetQuoteTest();
			SC_ID1729.DocumentsTest();
			takeScreenshot("Scenario_ID1729_DocumentsTest");
		}
