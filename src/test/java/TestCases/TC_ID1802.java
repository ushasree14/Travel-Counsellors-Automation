...
import Components.Scenario_ID1802;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1802 extends BaseClass {
	
	

	String expected_ID = "ID1802";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1802(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1802 SC_ID1802 = new Scenario_ID1802(driver);
	
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1802.GetQuoteTest(T1DOB);
			SC_ID1802.PreExistingMedicalQuesTest();
			takeScreenshot("Scenario_ID1802_PreExistingMedicalQuesTest");
		}
