...
public class TC_ID6119 extends BaseClass {
	
	String expected_ID = "ID6119";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6119(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6119 SC_ID6119 = new Scenario_ID6119(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			logger.info(TestCaseID);
			SC_ID6119.GetQuoteTest(T1DOB);
			SC_ID6119.PreExistingMedicalQuesTest();
			
			takeScreenshot("Scenario_ID6119_Payment_Details");
			logger.info("6119 Test Passed");
		}
	}
