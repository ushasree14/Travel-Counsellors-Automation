...
import Components.Scenario_ID1828;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1828 extends BaseClass {
	
	
	String expected_ID = "ID1828";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1828(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1828 SC_ID1828 = new Scenario_ID1828(driver);
	
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1828.GetQuoteTest(T1DOB);
			SC_ID1828.PreExistingMedicalQuesTest();
			takeScreenshot("Scenario_ID1828_PreExistingMedicalQuesTest");
		}
