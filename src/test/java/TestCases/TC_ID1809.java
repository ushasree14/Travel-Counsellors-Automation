...
import Components.Scenario_ID1809;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1809 extends BaseClass {
	
	String expected_ID = "ID1809";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1809(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1809 SC_ID1809 = new Scenario_ID1809(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1809.GetQuoteTest(StartDate, EndDate, T1DOB, T2DOB);
			SC_ID1809.PreExistingMedicalQuesTest();
			SC_ID1809.QuotePageTest();
			SC_ID1809.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID1809.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID1809_Payment_Details");
