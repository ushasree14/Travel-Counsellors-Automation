...
import Components.Scenario_ID6117;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6117 extends BaseClass {
	
	String expected_ID = "ID6117";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6117(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6117 SC_ID6117 = new Scenario_ID6117(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			logger.info(TestCaseID);
			SC_ID6117.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB, T5DOB);
		
			takeScreenshot("Scenario_ID6117_Payment_Details");
			logger.info("6117 Test Passed");
		}
	}
