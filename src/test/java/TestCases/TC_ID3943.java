...
import Components.Scenario_ID3943;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID3943 extends BaseClass {
	
	String expected_ID = "ID3943";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3943(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3943 SC_ID3943 = new Scenario_ID3943(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3943.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB);
			SC_ID3943.PreExistingMedicalQuesTest();
			SC_ID3943.QuotePageTest();
			SC_ID3943.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, FN_Traveler4, LN_Traveler4, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID3943.Payment_Details( cardnumber,  securityCVV);
			takeScreenshot("Scenario_ID3943_Payment_Details");
