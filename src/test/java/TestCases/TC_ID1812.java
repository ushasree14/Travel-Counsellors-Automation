...
import Components.Scenario_ID1812;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1812 extends BaseClass {
	String expected_ID = "ID1812";
	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1812(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1812 SC_ID1812 = new Scenario_ID1812(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1812.GetQuoteTest(StartDate, T1DOB);
			SC_ID1812.PreExistingMedicalQuesTest();
			SC_ID1812.QuotePageTest();
			SC_ID1812.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode, Phonenumber, Email);
			takeScreenshot("Scenario_ID1812_Travel_details_fields_1");
