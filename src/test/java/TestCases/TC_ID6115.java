...
import Components.Scenario_ID6115;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6115 extends BaseClass {
	
	String expected_ID = "ID6115";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6115(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6115 SC_ID6115 = new Scenario_ID6115(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			logger.info(TestCaseID);
			SC_ID6115.GetQuoteTest(T1DOB);
			
			takeScreenshot("Negative_Scenario_ID6115_Invalid_TDOB");
			logger.info("6115 Test Passed");
