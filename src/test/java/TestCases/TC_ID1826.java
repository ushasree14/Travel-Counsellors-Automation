...
import Components.Scenario_ID1826;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1826 extends BaseClass {
	
	String expected_ID = "ID1826";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1826(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1826 SC_ID1826 = new Scenario_ID1826(driver);
	
		//driver.get(URL);
	//	logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1826.GetQuoteTest(T1DOB);
			SC_ID1826.PreExistingMedicalQuesTest();
			takeScreenshot("Scenario_ID1826_PreExistingMedicalQuesTest");
		}
