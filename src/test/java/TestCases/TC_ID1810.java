...
import Components.Scenario_ID1810;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1810 extends BaseClass {
	String expected_ID = "ID1810";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1810(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1810 SC_ID1810 = new Scenario_ID1810(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1810.GetQuoteTest(StartDate, T1DOB);
			SC_ID1810.PreExistingMedicalQuesTest();
			SC_ID1810.QuotePageTest();
			SC_ID1810.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID1810.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID1810_Payment_Details");
