...
public class TC_ID3904 extends BaseClass {
	
	String expected_ID = "ID3904";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3904(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3904 SC_ID3904 = new Scenario_ID3904(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3904.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB);
			SC_ID3904.PreExistingMedicalQuesTest();
			SC_ID3904.QuotePageTest();
			SC_ID3904.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, FN_Traveler4, LN_Traveler4, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID3904.Payment_Details( cardnumber,  securityCVV);
			takeScreenshot("Scenario_ID3904_Payment_Details");
