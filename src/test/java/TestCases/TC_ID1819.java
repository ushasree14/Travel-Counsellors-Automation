...
import Components.Scenario_ID1819;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1819 extends BaseClass {
	
	
	String expected_ID = "ID1819";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1819(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1819 SC_ID1819 = new Scenario_ID1819(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1819.GetQuoteTest(T1DOB, StartDate, EndDate);
			takeScreenshot("Scenario_ID1819_GetQuoteTest");
		}
	}
