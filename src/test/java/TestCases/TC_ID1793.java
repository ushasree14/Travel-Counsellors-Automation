...
public class TC_ID1793 extends BaseClass {
	...
	String expected_ID = "ID1793";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1793(String TestCaseID, String Scenario_Description, String URL, String StartDate,
		...
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			...
			SC_ID1793.GetQuoteTest(T1DOB);
			SC_ID1793.PreExistingMedicalQuesTest();
			SC_ID1793.QuotePageTest();
			takeScreenshot("Scenario_ID1793_QuotePageTest");
		}
