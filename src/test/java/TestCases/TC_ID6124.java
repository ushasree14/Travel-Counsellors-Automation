...
import Components.Scenario_ID6124;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6124 extends BaseClass {
	
	String expected_ID = "ID6124";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6124(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6124 SC_ID6124 = new Scenario_ID6124(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6124.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID6124.PreExistingMedicalQuesTest();
			SC_ID6124.QuotePageTest();
			SC_ID6124.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode, Phonenumber, Email);
			
			takeScreenshot("Scenario_ID6124_Payment_Details");
			logger.info(" 6124 Test Passed");
		}
	}
