...
public class TC_ID1730 extends BaseClass {
	...
	String expected_ID = "ID1730";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1730(String TestCaseID, String Scenario_Description, String URL, String StartDate,
		...
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			...
			System.out.println("As a customer I want to see the ROCK/Travel Counsellor Privacy Policy");
			SC_ID1730.GetQuoteTest();
			SC_ID1730.DocumentsTest();
			takeScreenshot("Scenario_ID1730_DocumentsTest");
		}
