...
import Components.Scenario_ID1897;
import Utilities.BaseClass;
import Utilities.XLUtils;


public class TC_ID1897 extends BaseClass {
	
	String expected_ID = "ID1897";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1897(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1897 SC_ID1897 = new Scenario_ID1897(driver);
	
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1897.GetQuoteTest();
			takeScreenshot("Scenario_ID1897_GetQuoteTest");
		}
