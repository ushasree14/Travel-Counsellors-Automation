...
public class TC_ID1693 extends BaseClass {
	...
	String expected_ID = "ID1693";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1693(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		takeScreenshot("TC_LandingPage");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			System.out.println("As a customer I want to use Live Chat to communicate with sale agents: Check Live Chat working or not");
			SC_ID1693.GetQuoteTest();
			SC_ID1693.LiveChatTest();
			takeScreenshot("Scenario_ID1693_LiveChatTest");
		}
