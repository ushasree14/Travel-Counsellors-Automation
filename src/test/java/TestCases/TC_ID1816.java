...
import Components.Scenario_ID1816;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID1816 extends BaseClass {
	
	String expected_ID = "ID1816";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario1816(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID1816 SC_ID1816 = new Scenario_ID1816(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID1816.GetQuoteTest(T1DOB, T2DOB, T3DOB);
			SC_ID1816.PreExistingMedicalQuesTest();
			SC_ID1816.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, Address_Line1, city, County, PostCode);
			takeScreenshot("Scenario_ID1816_Travel_details_fields_1");
		}
	}
