...
import Components.Scenario_ID3972;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID3972 extends BaseClass {
	
	String expected_ID = "ID3972";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3972(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3972 SC_ID3972 = new Scenario_ID3972(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3972.GetQuoteTest(T1DOB, T2DOB, T3DOB, T4DOB, T5DOB, T6DOB, T7DOB, T8DOB);
			SC_ID3972.PreExistingMedicalQuesTest();
			SC_ID3972.QuotePageTest();
			SC_ID3972.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, FN_Traveler4, LN_Traveler4, FN_Traveler5, LN_Traveler5, FN_Traveler6, LN_Traveler6,
					FN_Traveler7, LN_Traveler7, FN_Traveler8, LN_Traveler8, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID3972.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID3972_Payment_Details");
