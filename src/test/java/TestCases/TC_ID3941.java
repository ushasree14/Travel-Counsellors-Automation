...
public class TC_ID3941 extends BaseClass {

	String expected_ID = "ID3941";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3941(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3941 SC_ID3941 = new Scenario_ID3941(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
	
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3941.GetQuoteTest(T1DOB, T2DOB, T3DOB);
			takeScreenshot("Scenario_ID3941_GetQuoteTest");
			SC_ID3941.PreExistingMedicalQuesTest();
			takeScreenshot("Scenario_ID3941_PreExistingMedicalQuesTest");
			SC_ID3941.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, Address_Line1, city, County, PostCode);
			takeScreenshot("Scenario_ID3941_Travel_details_fields_1");
			SC_ID3941.Medical_Conditions(med_conditionT1,med_conditionT2,med_conditionT3);
			takeScreenshot("Scenario_ID3941_Medical_Conditions");
			SC_ID3941.QuotePageTest();
			takeScreenshot("Scenario_ID3941_QuotePageTest");
			SC_ID3941.Travel_details_fields_2(Phonenumber, Email);
			takeScreenshot("Scenario_ID3941_Travel_details_fields_2");
			SC_ID3941.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID3941_policy creation page");
