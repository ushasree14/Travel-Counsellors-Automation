...
import Components.Scenario_ID6123;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6123 extends BaseClass {
	
	String expected_ID = "ID6123";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6123(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6123 SC_ID6123 = new Scenario_ID6123(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6123.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID6123.PreExistingMedicalQuesTest();
			SC_ID6123.QuotePageTest();
			SC_ID6123.Travel_details_fields_1();
			
			takeScreenshot("Scenario_ID6123_Payment_Details");
			logger.info(" 6123 Test Passed");
		}
	}
