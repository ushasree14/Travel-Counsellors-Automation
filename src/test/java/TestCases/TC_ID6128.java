...
import Components.Scenario_ID6128;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6128 extends BaseClass {
	
	String expected_ID = "ID6128";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6128(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6128 SC_ID6128 = new Scenario_ID6128(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6128.GetQuoteTest(StartDate, EndDate, T1DOB);
			SC_ID6128.PreExistingMedicalQuesTest();
			SC_ID6128.QuotePageTest();
			SC_ID6128.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID6128.Payment_Details(cardnumber, securityCVV);
			takeScreenshot("Scenario_ID6128_Payment_Details");
			logger.info("6128 Test Passed");
		}
	}
