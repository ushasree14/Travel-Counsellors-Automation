...
import Components.Scenario_ID3904;
import Components.Scenario_ID3986;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID3986 extends BaseClass {
	
	String expected_ID = "ID3986";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario3986(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID3986 SC_ID3986 = new Scenario_ID3986(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID3986.GetQuoteTest(StartDate, EndDate,T1DOB, T2DOB, T3DOB, T4DOB, T5DOB);
			
			SC_ID3986.PreExistingMedicalQuesTest();
			SC_ID3986.QuotePageTest();
			SC_ID3986.Travel_details_fields_1(FN_Traveler1, LN_Traveler1, FN_Traveler2, LN_Traveler2, FN_Traveler3,
					LN_Traveler3, FN_Traveler4, LN_Traveler4, FN_Traveler5, LN_Traveler5, Address_Line1, city, County, PostCode, Phonenumber, Email);
			SC_ID3986.Payment_Details( cardnumber,  securityCVV);
			takeScreenshot("Scenario_ID3986_Payment_Details");
