...
import Components.Scenario_ID6077;
import Utilities.BaseClass;
import Utilities.XLUtils;

public class TC_ID6077 extends BaseClass {
	
	String expected_ID = "ID6077";

	@Test(dataProvider = "TravelerDetailsScenarios", priority = 6)
	public void Scenario6077(String TestCaseID, String Scenario_Description, String URL, String StartDate, String EndDate, String T1DOB, String T2DOB, String T3DOB,
		...
		Scenario_ID6077 SC_ID6077 = new Scenario_ID6077(driver);
		//driver.get(URL);
		//logger.info("Launching the website");
		if (expected_ID.equalsIgnoreCase(TestCaseID)) {
			System.out.println(TestCaseID);
			SC_ID6077.GetQuoteTest(T1DOB);
			takeScreenshot("Scenario_ID6077_GetQuote");
